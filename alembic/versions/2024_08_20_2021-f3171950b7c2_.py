...
Revision ID: f3171950b7c2
Revises: 
Create Date: 2024-08-20 20:21:16.944228
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.UUID(), server_default='6624081a-0af5-499f-bde0-49385bdbf2da', nullable=False),
    ...
    sa.Column('id', sa.UUID(), server_default='46598cb1-4f12-4d75-8a6d-93c165c1bc41', nullable=False),
    sa.Column('user_id', sa.BIGINT(), nullable=True),
    sa.Column('total', sa.Double(), server_default='0', nullable=True),
    sa.Column('expiration_time', sa.DateTime(timezone=True), server_default='2024-08-21 20:21:16.738399', nullable=False),
    sa.Column('created_at', sa.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=False),
