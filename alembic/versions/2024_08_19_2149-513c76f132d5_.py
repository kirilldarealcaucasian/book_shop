...
Revision ID: 513c76f132d5
Revises: 
Create Date: 2024-08-19 21:49:01.721134
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.UUID(), server_default='d8f53925-3094-448c-afae-e17b550b40a2', nullable=False),
    ...
    sa.Column('id', sa.UUID(), server_default='0ac14c70-e841-4a06-9828-167e8559de92', nullable=False),
    sa.Column('user_id', sa.BIGINT(), nullable=True),
    sa.Column('total', sa.Double(), server_default='0', nullable=True),
    sa.Column('expiration_time', sa.DateTime(timezone=True), server_default='2024-08-20 21:49:01.527379', nullable=False),
    sa.Column('created_at', sa.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=False),
