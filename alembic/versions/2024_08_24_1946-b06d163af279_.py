...
Revision ID: b06d163af279
Revises: 
Create Date: 2024-08-24 19:46:10.431780
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.UUID(), server_default='a8911e47-2964-4748-a055-e58abe49e87c', nullable=False),
    ...
    sa.Column('id', sa.UUID(), server_default='69557211-8ba4-499d-8e2b-c35c7d691603', nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=True),
    sa.Column('total', sa.Double(), server_default='0', nullable=True),
    sa.Column('expiration_time', sa.DateTime(timezone=True), server_default='2024-08-25 19:46:10.182546', nullable=False),
    sa.Column('created_at', sa.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=False),
    ...
    sa.UniqueConstraint('session_id', 'book_id', name='uq_cart_items_book_id_session_id')
    )
